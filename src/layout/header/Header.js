        ...
        <div className="nk-header-wrap">
          ...
          <div className="nk-header-app-name">
            <div className="nk-header-app-logo">
              <Icon name="book" className="bg-purple-dim"></Icon>
            </div>
            <div className="nk-header-app-info">
              <span className="sub-text">Faculty</span>
              <span className="lead-text">Panel</span>
            </div>
          </div>
          <div className="nk-header-menu is-light">
            <div className="nk-header-menu-inner">
              <ul className="nk-menu nk-menu-main">
                ...
                >
                  <Link to={currentUrl} className="nk-menu-link">
                    <span className="nk-menu-text">Faculty Management System</span>
                  </Link>
                </li>
                {/* <li
