...
import { FContextProvider } from "../pages/pre-built/faculty/FContext";
import { EContextProvider } from "../pages/pre-built/education/EContext";
import { WContextProvider } from "../pages/pre-built/work/WContext";
import { CContextProvider } from "../pages/pre-built/civil/CContext";
import { PContextProvider } from "../pages/pre-built/program/PContext";
...
import FList from "../pages/pre-built/faculty/FList";
import EList from "../pages/pre-built/education/EList";
import WList from "../pages/pre-built/work/WList";
import CList from "../pages/pre-built/civil/CList";
import PList from "../pages/pre-built/program/PList";

import ProductDetails from "../pages/pre-built/products/ProductDetails";
import FDetails from "../pages/pre-built/faculty/FDetails";
import EDetails from "../pages/pre-built/education/EDetails";
import CDetails from "../pages/pre-built/civil/CDetails";
import WDetails from "../pages/pre-built/work/WDetails";
import PDetails from "../pages/pre-built/program/PDetails";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/education/:level`}
          render={(props) => (
            <EContextProvider>
              <EList {...props} />
            </EContextProvider>
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/civils`}
          render={(props) => (
            <CContextProvider>
              <CList />
            </CContextProvider>
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/learnings`}
          render={(props) => (
            <PContextProvider>
              <PList />
            </PContextProvider>
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/civil/:id`}
          render={(props) => (
            <CContextProvider>
              <CDetails {...props} />
            </CContextProvider>
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/education/detail/:id`}
          render={(props) => (
            <EContextProvider>
              <EDetails {...props} />
            </EContextProvider>
