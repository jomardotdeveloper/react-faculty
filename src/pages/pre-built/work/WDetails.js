          ...
          <Block>
            ...
            <Card className="card-bordered">
              <div className="card-inner">
                ...
                <div className="overline-title-alt mb-2">Work Experience</div>
                <hr className="hr border-light" />
                <Row>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.title}</span>
                      <span className="sub-text">Position Title</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.company}</span>
                      <span className="sub-text">Company or Department</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                  ...
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.msalary}</span>
                      <span className="sub-text">Monthly Salary</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.salary}</span>
                      <span className="sub-text">Salary</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.status}</span>
                      <span className="sub-text">Status of appointment</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.govt ? "Yes" : "No"}</span>
                      <span className="sub-text">Government Service</span>
                    </div>
                  </Col>
                </Row>
              </div>
