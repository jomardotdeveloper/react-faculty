          ...
          <Block>
            ...
            <Card className="card-bordered">
              <div className="card-inner">
                ...
                <div className="overline-title-alt mb-2">Education Background</div>
                <hr className="hr border-light" />
                <Row>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.name}</span>
                      <span className="sub-text">School Name</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.course}</span>
                  ...
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.units}</span>
                      <span className="sub-text">Highest Units Earned</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.honors}</span>
                      <span className="sub-text">Honors Received</span>
                    </div>
                  </Col>
                </Row>
              </div>
