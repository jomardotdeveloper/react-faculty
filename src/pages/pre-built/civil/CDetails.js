          ...
          <Block>
            ...
            <Card className="card-bordered">
              <div className="card-inner">
                ...
                <div className="overline-title-alt mb-2">Civil Service Eligibility</div>
                <hr className="hr border-light" />
                <Row>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.career}</span>
                      <span className="sub-text">Career Service</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.rating}</span>
                      <span className="sub-text">Rating</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.date}</span>
                      <span className="sub-text">Date of Examination</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.place}</span>
                      <span className="sub-text">Place of Examination</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.lnumber}</span>
                      <span className="sub-text">License Number</span>
                    </div>
                  </Col>
                  <Col lg={3} className="mt-2">
                    <div className="profile-stats">
                      <span className="amount">{currentUser.ldate}</span>
                      <span className="sub-text">License Date of Validity</span>
                    </div>
                  </Col>
                </Row>
              </div>
